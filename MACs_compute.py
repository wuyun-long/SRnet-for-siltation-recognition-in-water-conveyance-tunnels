...
def net_flops(model, table=False):
    ...
    for l in model.layers:
        ...
        if ('batch_normalization' in str(l) or 'BatchNormalization' in str(l)):
            i_shape = l.input.get_shape()[1:4].as_list()
            o_shape = l.output.get_shape()[1:4].as_list()
